...
import PatientFollowUpsPage     from './pages/patient/FollowUps'
import FamilyMembersPage        from './pages/patient/FamilyMembers'
import MenstrualTrackerPage     from './pages/patient/MenstrualTracker'
import PregnancyTrackerPage     from './pages/patient/PregnancyTracker'
import VaccinationTrackerPage   from './pages/patient/VaccinationTracker'
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <main className="flex-1 min-w-0 overflow-y-auto" id="main-content">
          <Routes>
            ...
            <Route path="/asha/direct-teleconsult" element={<AshaDirectTeleconsultPage />} />
            ...
            <Route path="/patient/menstrual"    element={<MenstrualTrackerPage />} />
            <Route path="/patient/pregnancy"    element={<PregnancyTrackerPage />} />
            <Route path="/patient/vaccinations" element={<VaccinationTrackerPage />} />
